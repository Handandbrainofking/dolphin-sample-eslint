<template>
  <div class="flex-column center">
    ...
    <text class="h2">华为智能灯</text>
    <text class="h4 margin-top-40 margin-bottom-20">美居控制华为平台设备(T0x13)-智能灯插件标准</text>
    <dof-button text="快速查看" type="primary" size="big" @dofButtonClicked="jumpTo"></dof-button>
    <!-- <div class="document-url">
      <a href="http://confluence.msmart.com/pages/viewpage.action?pageId=30122052">
        <text>需求文档</text>
      </a>
    </div> -->
    <div class="footer">
