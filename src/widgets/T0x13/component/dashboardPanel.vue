...
import demo1 from '../assets/animation/keepHeat.json'
import demo2 from '../assets/animation/heating.json'
import demo3 from '../assets/animation/highTemp.json'
import demo5 from '../assets/animation/btn-keepHeat.json'
