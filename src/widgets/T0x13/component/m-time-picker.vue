    ...
    <div class="midea-body">
      <div style="width:750px">
        ...
        <midea-radio-list
          ...
          :needShowLastBottomBorder="true"
          @mideaRadioItemChecked="repeatSelect"
        ></midea-radio-list>
        <option-list-circle
          v-if="currentSelectedType == '4'"
          :cols="cols"
          :customStyles="customStyles"
          :list="dayList"
          @optionClick="dayChange"
        ></option-list-circle>
      </div>
    </div>
  </div>
...
import mideaRadioList from './radioList'
import optionListCircle from './option-list-circle'
